...
func (s *Scheduler) runJob(ctx context.Context, job parser.Job, jobRunner runner.Runner, store runlog.Store) {
	...
	result := jobRunner.RunWithOutputAndPID(ctx, job, handle.StartedAt(), liveWriter, func(pid int) {
